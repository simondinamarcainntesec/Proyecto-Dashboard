...
def dashboard_view(request):
    tenant = request.tenant  # para cache key y mostrar en UI

    # -------- 1) Parseo de fechas y rango SIEMPRE definido --------
    ...
    # Fechas para inputs (mostrar día local)
